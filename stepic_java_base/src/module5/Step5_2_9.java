 ...
 * <p>
 * Напишите программу, которая будет преобразовывать переводы строк из формата Windows в формат Unix. Данные в формате Windows подаются программе в System.in,
 * преобразованные данные должны выводиться в System.out. На этот раз вам надо написать программу полностью, т.е. объявить класс (с именем Main — таково ограничение проверяющей системы),
 ...
 * <p>
 * Кодировка входных данных такова, что символ '\n' представляется байтом 10, а символ '\r' — байтом 13. Поэтому программа может осуществлять фильтрацию на уровне двоичных данных,
 ...
 */
public class Step5_2_9 {
    public static void main(String[] args) {
        int readByte = 0;
        int nextReadByte = 0;
        try {
            while ((readByte = System.in.read()) > 0) {
                if (readByte == 13 && (nextReadByte = System.in.read()) == 10) {
                    System.out.write(10);
                } else if (readByte == 13) {
                    System.out.write(readByte);
                    System.out.write(nextReadByte);
                } else {
                    System.out.write(readByte);
                }
            }
