 ...
 * каких-либо ключевых слов (в случае спама мы получаем их из конструктора, в случае негативного текста мы заранее знаем набор грустных смайликов)
 ...
 * <p>
 * Created by Andrey on 27.09.2016.
 */
public class Step3_5_9 {
    public Label checkLabels(TextAnalyzer[] analyzers, String text) {
        for (TextAnalyzer analyzer : analyzers) {
            Label currLabel = analyzer.processText(text);
            if (Label.OK != currLabel) return currLabel;
        }
        return Label.OK;
    }
